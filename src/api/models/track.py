...
from models.track import Track  # 👈 IMPORTANTE: Importa tu modelo Track original
...
class RecommendedTrack(BaseModel):
    ...
    track_details: Optional[Track] = None  # 👈 CORREGIDO: Para poder transportar la info hidratada al frontend
